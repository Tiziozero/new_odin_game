...
main :: proc() {
    ...
    for !raylib.WindowShouldClose() {
        ...
        // update camera
        camera.x = player.body.x - 4*SCREEN_SCALE/2 + player.body.width/2;
        camera.y = player.body.y - 3*SCREEN_SCALE/2 + player.body.height/2;
